...
// end include: preamble.js
  ...
  function _ListFriendsSDK(page, size) {
      page = parseInt(page);
      size = parseInt(size);
      window.CrazyGames.SDK.user
  ...
  function _RegisterAuthListenerSDK() {
  ...
  function _SubmitUserScoreSDK(score) {
      try {
        var payload = {
...
var wasmImports = {
  "AddUserScoreSDK": _AddUserScoreSDK,
  "AnalyticsTrackOrderSDK": _AnalyticsTrackOrderSDK,
  "CopyToClipboardSDK": _CopyToClipboardSDK,
  "DataClearSDK": _DataClearSDK,
  "DataGetItemSDK": _DataGetItemSDK,
  "DataHasKeySDK": _DataHasKeySDK,
  "DataRemoveItemSDK": _DataRemoveItemSDK,
  "DataSetItemSDK": _DataSetItemSDK,
  "GameplayStartSDK": _GameplayStartSDK,
  "GameplayStopSDK": _GameplayStopSDK,
  "GetEnvironmentSDK": _GetEnvironmentSDK,
  "GetGameSettingsJSONSDK": _GetGameSettingsJSONSDK,
  "GetInviteLinkParamSDK": _GetInviteLinkParamSDK,
  "GetIsQaToolSDK": _GetIsQaToolSDK,
  "GetJSLoadTimeInfo": _GetJSLoadTimeInfo,
  "GetJSMemoryInfo": _GetJSMemoryInfo,
  "GetSystemInfoSDK": _GetSystemInfoSDK,
  "GetUserSDK": _GetUserSDK,
  "GetUserTokenSDK": _GetUserTokenSDK,
  "GetXsollaUserTokenSDK": _GetXsollaUserTokenSDK,
  "HappyTimeSDK": _HappyTimeSDK,
  "HideInviteButtonSDK": _HideInviteButtonSDK,
  "InitSDK": _InitSDK,
  "IsUserAccountAvailableSDK": _IsUserAccountAvailableSDK,
  ...
  "ListFriendsSDK": _ListFriendsSDK,
  "PrefetchAdSDK": _PrefetchAdSDK,
  "RegisterAuthListenerSDK": _RegisterAuthListenerSDK,
  "RequestAdSDK": _RequestAdSDK,
  "RequestBannersSDK": _RequestBannersSDK,
  "RequestInviteUrlSDK": _RequestInviteUrlSDK,
  "ShowAccountLinkPromptSDK": _ShowAccountLinkPromptSDK,
  "ShowAuthPromptSDK": _ShowAuthPromptSDK,
  "ShowInviteButtonSDK": _ShowInviteButtonSDK,
  "SubmitUserScoreSDK": _SubmitUserScoreSDK,
  "SyncUnityGameDataSDK": _SyncUnityGameDataSDK,
